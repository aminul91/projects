...
<div class="container">
    <p>
        <button href="/admin/candidates"  style="background-color: bisque;" class="add-new btn btn-primary">Add Candidate</button>
    </p>
    ...
    <div style="color:blue;margin-left: 30px" class="col-1" align="center">
        <a href="/"  style="background-color: bisque;">Home</a>
    </div>
</div>
